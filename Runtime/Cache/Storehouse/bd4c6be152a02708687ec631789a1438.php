        ...
        <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
                ...
                <div class="widget-content padded">
                    <form action="<?php echo U('Storehouse/Cpruku/addInsert');?>" id="validate-form" method="post" class="form-horizontal">
                        <div class="form-group">
                            <fieldset disabled>
                                <label class="control-label col-md-2" for="code">入库编号</label>
                                <div class="col-sm-2" >
                                    <input id="code" name="ruku_code" class="form-control" placeholder="系统自动生成" type="text" value="<?php echo ($Ruku['ruku_code']); ?>">
                                </div>
                                <label class="control-label col-md-1" for="ruku_creator">操作人</label>
                                <div class="col-sm-2" >
                                    <input id="ruku_creator" name="ruku_creator" class="form-control" placeholder="系统自动生成" type="text" value="<?php echo ($creator); ?>">
                                </div>
                            </fieldset>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="input-group date datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
                                    <input id="ruku_date" name="ruku_date" class="form-control" type="text" value="<?php echo ($Main['date']); ?>">
                                    <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                </div>
                            </div>
                            <label class="control-label col-md-1" for="kind">入库类型</label>
                            <div class="col-md-2">
                              <select id="kind" name="kind" class="form-control">
                                <option value="0" <?php if($Main['kind']==0): ?>selected="selected"<?php endif; ?>>自产入库</option>
                                <option value="1" <?php if($Main['kind']==1): ?>selected="selected""<?php endif; ?>>外购入库</option>
                              </select>
                            </div>
                            <?php if($Main['kind']==1): ?><div id="cpsupplier">
                            <label class="control-label col-md-1" for="supplier_name">供应商名称</label>
                            <div class="col-xs-6 col-sm-1" style="width:15%;">
                              <div class="input-group">
                                <input class="form-control" type="text" id="supplier_name" name="supplier_name" value="<?php echo ($Main['supplier_name']); ?>"><span class="input-group-btn"><a id="supplierSelect" class="btn btn-default" type="button" data-toggle="modal" href="#myModal">请选择</a></span></input>
                                <input type="hidden" id="sid" name="sid" value="<?php echo ($Main['sid']); ?>">
                              </div>
                            </div>
                            </div><?php endif; ?>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-sm-8">
                                    <textarea class="form-control" name="memo" rows="2"><?php echo ($Main['memo']); ?></textarea>
                                </div>
                            </div>
                            <div class="heading">
                            ...
                            <?php if(is_array($Ruku)): foreach($Ruku as $key=>$v): ?><div class="form-group product" style="margin-bottom:5px;">
                                ...
                                <div class="col-sm-2">
                                  <div class="input-group">
                                    <input class="form-control" type="text" id="product_code" value="<?php echo ($v['code']); ?>"><span class="input-group-btn"><a id="productSelectcp" class="btn btn-default productSelectcp" type="button" data-toggle="modal" href="#myModalc">请选择</a></span></input>
                                    <input type="hidden" id="productId" name="productId[]" value="<?php echo ($v['productId']); ?>">
                                    <input type="hidden" id="sonId" name="sonId[]" value="<?php echo ($v['rukuProId']); ?>">
                                  </div>
                                </div>
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" id="product_name" value="<?php echo ($v['name']); ?>">
                                </div>
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" id="product_color" value="<?php echo ($v['color']); ?>">
                                </div>
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" name="cnt[]" value="<?php echo ($v['cnt']); ?>">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9 col-md-2">
                                    ...
                                    <input id="ruku_code" name="ruku_code" type="hidden" value="<?php echo ($Main['ruku_code']); ?>">
                            ...
                            <div class="contact2 product">
                                <div class="form-group" style="margin-bottom:5px;">
                                    ...
                                    <div class="col-sm-2">
                                      <div class="input-group">
                                        <input class="form-control" type="text" id="product_code" value="<?php echo ($Product['product_code']); ?>"><span class="input-group-btn"><a id="productSelectcp" class="btn btn-default productSelectcp" type="button" data-toggle="modal" href="#myModalc">请选择</a></span></input>
                                    ...
                                    <div class="col-sm-2">
                                        <input class="form-control" type="text" id="product_color" value="<?php echo ($Product['product_color']); ?>">
                                    </div>
                                    <div class="col-sm-2">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.ruku_remove').click(function(){
            ...
            $.post('<?php echo U("Storehouse/Cpruku/deletesonid");?>',{id:sonid},function(){
                location.reload();
            })

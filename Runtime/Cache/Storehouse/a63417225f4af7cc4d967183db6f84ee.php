        ...
        <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
                ...
                <div class="widget-content padded">
                    <form action="<?php echo U('Storehouse/Chuku/addInsert');?>" id="validate-form" method="post" class="form-horizontal">
                            <div class="form-group">
                                <fieldset disabled class="col-md-6">
                                   <div class="form-group">
                                     <label class="control-label col-md-6">出库编号</label>
                                     <div class="col-xs-6 col-sm-4">
                                       <input id="chuku_code" name="chuku_code" class="form-control" placeholder="系统自动生成" type="text" value="<?php echo ($Chuku['chuku_code']); ?>">
                                     </div>
                                   </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-6">操作人</label>
                                        <div class="col-xs-6 col-sm-4">
                                            <input id="creator" name="creator" class="form-control" placeholder="系统自动生成" type="text" value="<?php echo ($creator); ?>">
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <div class="input-group date datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
                                      <input id="chuku_date" name="chuku_date" class="form-control" type="text" value="<?php echo ($date); ?>"><span class="input-group-addon"><i class="icon-calendar"></i></span></input>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <input id="chukuKind" name="chukuKind" class="form-control" readonly="true" type="text" value="<?php echo ($chukuKind); ?>">
                                </div>
                            </div>
                                   ...
                                   <label class="control-label col-md-3"></label>
                                    <div class="col-sm-2">
                                      <div class="input-group">
                                        ...
                                        <input type="hidden" id="productId" name="productId[]" value="<?php echo ($Chuku['sid']); ?>">
                                    ...
                                    <div class="col-sm-1" style="margin-left:1.7%;">
                                        <input class="form-control" type="text" name="cnt[]" value="<?php echo ($Chuku['cnt']); ?>">
                                    </div>
                                </div>
                                <div class="form-group product" style="margin-bottom:5px;">

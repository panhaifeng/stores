...
.chuku_remove { margin-left:1%;} 
  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="icon-table"></i><a class="btn-primary" href="<?php echo U('Storehouse/Chengpin/index');?>" style="padding:4px;border-radius:3px">库存查询</a>
        <a href="<?php echo U('Storehouse/Cpruku/index');?>" style="margin-left:5%;">成品入库</a>
        ...
        <button class="btn btn-sm btn-success-outline pull-right" id="quickSubmit" style="display: none" data-url="<?php echo U('Storehouse/Cpchuku/listAdd');?>">
          <i class="icon-upload"></i><span>提交至出库界面</span>「<span id="chukuChengpinNum" data-count="0">0</span>项」
        </button>
        <a class="btn btn-sm btn-primary-outline pull-right" id="exportBtn" href="<?php echo U('Storehouse/Chengpin/index', $arr+array('export'=>1));?>">
          <span>导出库存</span>
        </a>
      </div>
      <div class="widget-content padded clearfix normalSearch">
      <form action="<?php echo U('Storehouse/Chengpin/index');?>" class="form-horizontal" method="post">
          <table class="tab search">
              ...
              <tr>
                  ...
                  <td>
                      <input class="form-control" id="key" name="key" placeholder="关键词检索:编码、名称.." type="text" value="<?php echo ($key); ?>">
                  </td>
                  <td>
        ...
        <div class="widget-content padded clearfix quickSearch" style="display: none">
            <table class="tab search">
                ...
                <tr>
                    <td>
                        <input class="form-control"  name="start_time" placeholder="开始时间" type="text" value="<?php echo ($start_time); ?>" disabled>
                    </td>
                    <td>
                        <input class="form-control" name="end_time" placeholder="结束时间" type="text" value="<?php echo ($end_time); ?>" disabled>
                    </td>
                    <td>
                        <input class="form-control" name="key" placeholder="关键词检索:编码、名称.." type="text" value="<?php echo ($key); ?>" disabled>
                    </td>
                    <td>
      ...
      <div class="widget-content padded clearfix rowsData">
        ...
        <table class="table table-bordered table-striped">
         <thead>
          ...
          <tbody>
            <?php if(is_array($Kucun)): foreach($Kucun as $key=>$v): ?><tr>
                <td><?php echo ($v['code']); ?></td>
                <td><?php echo ($v['kind']); ?></td>
                <td><?php echo ($v['name']); ?></td>
                <td><?php echo ($v['color']); ?></td>
                <!--<td><?php echo ($v['norms']); ?></td>-->
                <td><?php echo ($v['initKucun']); ?></td>
                <td><?php echo ($v['cntRuku']); ?></td>
                <td><?php echo ($v['cntChuku']); ?></td>
                <td><?php echo ($v['cnt']); ?></td>
                <td class="quickColumn"  style="display: none">
                    <label class="checkbox-inline">
                        <input type="checkbox" value="<?php echo ($v['proId']); ?>" name="preChuku[]" autocomplete="off" data-choose="false">
                        <span></span>

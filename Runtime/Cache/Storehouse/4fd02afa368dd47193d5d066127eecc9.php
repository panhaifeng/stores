                    ...
                    <form action="<?php echo U('Storehouse/Cpruku/addInsert');?>" id="validate-form" method="post" class="form-horizontal">
                            <div class="form-group">
                                <fieldset disabled>
                                    ...
                                    <div class="col-md-2" >
                                        <input id="ruku_code" name="ruku_code" class="form-control" placeholder="系统自动生成" type="text" value="<?php echo ($Ruku['ruku_code']); ?>">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group date datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd">
                                      <input id="ruku_date" name="ruku_date" class="form-control" type="text" value="<?php echo ($date); ?>"><span class="input-group-addon"><i class="icon-calendar"></i></span></input>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                  <select id="kind" name="kind" class="form-control">
                                    <option value="0" <?php if($Ruku['kind']==0): ?>select="selected"<?php endif; ?>>自产入库</option>
                                    <option value="1" <?php if($Ruku['kind']==1): ?>select="selected"<?php endif; ?>>外购入库</option>
                                  </select>
                                </div>
                                <div id="cpsupplier">

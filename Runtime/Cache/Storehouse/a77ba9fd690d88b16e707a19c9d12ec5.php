...
.chuku_remove { margin-left:1%;} 
  ...
  <div class="col-lg-12">
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        <i class="icon-table"></i><a class="btn-primary" href="<?php echo U('Storehouse/Index/index');?>" style="padding:4px;border-radius:3px;">库存查询</a>
        <a href="<?php echo U('Storehouse/Ruku/index');?>" style="margin-left:5%;">原料入库</a>
        <a href="<?php echo U('Storehouse/Chuku/index');?>" style="margin-left:5%;">原料出库</a>

      <a class="btn btn-sm btn-primary-outline pull-right" href="<?php echo U('Storehouse/Index/index', $arr+array('export'=>1));?>">
          <span>导出库存</span>
      </a>
      </div>
      <div class="widget-content padded clearfix">
      <form action="<?php echo U('Storehouse/Index/index');?>" class="form-horizontal" method="post">
        <table class="tab search">
          <tbody>
            <tr>
              ...
              <td>
                  <input class="form-control" id="key" name="key" placeholder="关键词检索" type="text" value="<?php echo ($key); ?>">
              </td>
         ...
         <thead>
          ...
          <tbody>
            <?php if(is_array($Kucun)): foreach($Kucun as $key=>$v): ?><tr>
                ...
                <td><?php echo ($v['cntChukuAuto']); ?></td>
                <td><?php echo ($v['cntChukuQt']); ?></td>
                <td><?php echo ($v['cnt']); ?></td>
                <td>
                    <a class="table-actions" data-toggle="modal" href="#myModalp<?php echo ($v['proId']); ?>"><i class="glyphicon glyphicon-credit-card" title="实际库存"></i></a>
                      <!--模态框 -->
                      <div class="modal fade" id="myModalp<?php echo ($v['proId']); ?>">
                        <div class="modal-dialog">
                          <form action="<?php echo U('Storehouse/Ruku/kcTz');?>" class="form-horizontal" method="post">
                              ...
                              <div class="form-group">
                                <div class="col-md-8">
                                  <div class="input-group">
                                    ...
                                    <input id="proId" name="proId" class="form-control" type="hidden" value="<?php echo ($v['proId']); ?>">
                                  </div>
                                </div>
                              </div>
                            </div>

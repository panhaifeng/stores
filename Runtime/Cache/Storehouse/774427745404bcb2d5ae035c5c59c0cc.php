  ...
  <div class="col-lg-12"> 
    <div class="widget-container fluid-height clearfix">
      <div class="heading">
        ...
        <a class="btn-primary" href="<?php echo U('Storehouse/Ruku/index');?>" style="margin-left:5%;padding:4px;border-radius:3px">原料入库</a> 
	    <a href="<?php echo U('Storehouse/Chuku/index');?>" style="margin-left:5%;">原料出库</a> 
	    <a class="btn btn-sm btn-primary-outline pull-right" href="<?php echo U('Storehouse/Ruku/add');?>"> 
          <i class="icon-plus"></i>新增原料入库 
        </a> 
      </div>
      <div class="widget-content padded clearfix"> 
      <form action="<?php echo U('Storehouse/Ruku/index');?>" class="form-horizontal" method="post"> 
      ...
      <div class="widget-content padded clearfix"> 
        ...
        <table class="table table-bordered table-striped"> 
         <thead>
          ...
          <tbody> 
         	<?php if(is_array($Ruku)): foreach($Ruku as $key=>$v): ?><tr class="newSon" style="cursor:pointer;"> 
          ...
          <a class="table-actions" href="<?php echo U('Storehouse/Ruku/edit',array('id'=>$v['id']));?>"><i class="icon-pencil"></i></a>
                <a class="table-actions" data-toggle="modal" href="#myModal<?php echo ($v['id']); ?>"><i class="icon-trash"></i></a> 
             <!--  <?php if($v['rukuKind']=='原料退回'): ?><a class="table-actions" href="<?php echo U('Storehouse/Tui/edit',array('id'=>$v['id']));?>"><i class="icon-pencil"></i></a>
                <a class="table-actions" data-toggle="modal" href="#myModal<?php echo ($v['id']); ?>"><i class="icon-trash"></i></a> 
              <?php else: ?> -->
             ...
             <!--  <?php if($v['rukuKind']=='原料入库'): ?><a class="table-actions" href="<?php echo U('Storehouse/Tui/back',array('id'=>$v['id']));?>"><i class="icon-reply" title="退货"></i></a><?php endif; ?> -->
					  <!--删除模态框 -->
	                    ...
	                    <div class="modal-dialog">
	                      <div class="modal-content">
	                        ...
	                        <div class="modal-footer">
	                          <a class="btn btn-primary" type="button" href="<?php echo U('Storehouse/Ruku/delect',array('id'=>$v['id']));?>">删除</a>
